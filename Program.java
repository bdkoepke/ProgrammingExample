public class Program {
  ...
  private static void printPerson(String prefix, Person p) {
	...
	public static void main(String... args) {
		...
		Recursion._for(0, new Predicate<Integer>() { public boolean apply(Integer i) { return i < 10; } }, new BiFunction<Integer>() { public Integer apply(Integer i) { return i + 1; } }, new Action<Integer>() { public void apply(Integer i) { System.out.println("The value of i is: " + i); } });
		newline();
